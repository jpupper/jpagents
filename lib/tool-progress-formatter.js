...
// Mapa de emojis por tool — mismo que Hermes Desktop + Agent
const TOOL_EMOJIS = {
    terminal: '💻',
    web_search: '🔍',
    web_extract: '🌐',
...
/**
 * Obtiene el emoji para un tool.
 */
export function getToolEmoji(toolName, defaultEmoji = '⚡') {
    return TOOL_EMOJIS[toolName] || defaultEmoji;
}
