...
import { scene, createGroundFloor } from './scene.js';
import { S } from './state.js';
import { createProjectNode, buildMage, buildLabel } from './builders.js';
import { updateFlameScale, ARCANE_TOOL_WORDS, ARCANE_RUNES, ARCANE_SYMBOLS } from './effects.js';
import { updatePanel, updateFocusPanel, unfocusAgent, hideProjectInfo, applyCustomColors } from './panels.js';
...
export function rebuildScene() {
  ...
  projKeys.forEach((projKey, pIdx) => {
    ...
    agentsInGroup.forEach((agent, aIdx) => {
      ...
      applyCustomColors(agent.id || agent.pid, mage);
