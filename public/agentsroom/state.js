...
// All modules import { S } from './state.js' to access shared state.
...
// ─── SHARED STATE OBJECT ───
// All mutable state lives here. Modules access via `import { S } from './state.js'`.
const S = {};
...
S.pedestalState = null; // { projKey, nodeGroup, animT, initialCamPos, initialTarget, targetPos, angle }
S.customColors = {}; // { agentId: { body: '#hex', hat: '#hex', ... } }
S.centerSummonGroup = null;
S.centerSummonIntensity = 0; // 0-1 computed from active agents
